...
class DirectionalMarketMakerWs:
    ...
    def subscribe_to_ws(self):
        ...
        return self._subscribe_to_balance_ws(ws_exchange)

    stop_ws = False

    async def _subscribe_to_balance_ws(self, exchange):
...
def bybit_auto_rotation_spot(args, market_maker, manager, symbols_allowed):
    ...
    market_maker = DirectionalMarketMakerWs(config, args.exchange, args.account_name)
    market_maker.manager = manager
...
async def main():
   ...
   |     DirectionalScalper Activated     |
    ...
    exchange_name = args.exchange
    try:
        market_maker = DirectionalMarketMakerWs(config, exchange_name, args.account_name)
    except Exception as e:
